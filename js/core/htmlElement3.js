...
//	the class for the actual DOM elements,  so we need to change our
//	class name to avoid confusion and anomolous behaviour.
...
var doc_body
function htmlElement3_init() {
	doc_body = new Element(document.body)
	}
