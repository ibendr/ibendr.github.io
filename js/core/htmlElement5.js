...
// 2016 - version 5 - dropped cloning stuff, consistent with dom3

/* Arguments to htmlElement constructor:

el:   if wrapping existing element:
		DOM element object or "_" + element id
...
function htmlElement( el , parts , getAtts , getKids ) {
	...
	// should be able to use stricter:
	if ( el instanceof Element ) {
// 	if ( elType == "object" ) {    // older version
