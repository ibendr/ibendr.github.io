...
// 	let styl = {
// 	    width:       px( pa.scalePx - pa.linePx ) ,
// 	    height:      px( pa.scalePx - pa.linePx ) ,
// 	    fontSize:    px( pa.scalePx * 1.6 / ( lbl.length + 1 ) ) ,
// 	    borderWidth: px( pa.linePx )
// 	} ;
	styl = styl ?? { height: "128px" , width: "128px" , fontSize: "96px" , borderRadius: "8px" , position: "absolute" } ;
